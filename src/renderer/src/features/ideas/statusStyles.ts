...
export const STATUS_STYLES: Record<IdeaStatus, string> = {
  ...
  preparation: 'bg-violet-500/20 text-violet-300 border-violet-500/40',
  shooting: 'bg-red-500/20 text-red-300 border-red-500/40',
  editing: 'bg-orange-500/20 text-orange-300 border-orange-500/40',
...
export const STATUS_ROW_BACKGROUND: Record<IdeaStatus, string> = {
  idea: '',
  preparation: 'bg-violet-500/10 hover:bg-violet-500/15',
  shooting: 'bg-red-500/10 hover:bg-red-500/15',
  editing: 'bg-orange-500/10 hover:bg-orange-500/15',
