...
export interface Task {
  ...
  dueTime: string | null
  status: TaskStatus
  // True for tasks created by an automation rule (e.g. "objet à acheter") rather than by hand —
  // shown differently and kept in sync with the condition that created them.
...
export type TaskInput = Omit<
  Task,
  'id' | 'createdAt' | 'updatedAt' | 'autoGenerated' | 'typeIds' | 'ideaIds'
> & {
  typeIds: number[]
  ideaIds: number[]
}
